        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
            ...
            <div class="form-group">
                ...
                <select id="paket" name="paket">
                    <option value="Self Studio" <?php echo ($paket == "Self Studio") ? "selected" : ""; ?>>Self Studio</option>
                    <option value="Prewedding" <?php echo ($paket == "Prewedding") ? "selected" : ""; ?>>Prewedding</option>
